...
class SalesGPT(Chain):
    ...
    salesperson_name: str = "Motilda Sergeevna"
    salesperson_role: str = "Business Sales Representative"
    company_name: str = "TeeCustomizer"
    company_business: str = "TeeCustomizer is a made up platform where users can design and order customizable t-shirts."
    company_values: str = "Our mission at TeeCustomizer is to help people look better and reflect personal individuality. Utilizing the best in fabric printing and automatic embroidery technology, we provide the fastest production times and widest range of products to our customers."
    conversation_purpose: str = "Sale the t-shirt and answer to the questions of user."
    mandatory_product_features: str = dedent(
        """Styles, possible values: [Crew Neck, V-Neck, Long Sleeve, Tank Top],
        Genders, possible values: [Male, Female, Unisex],
        Colors, possible values: [white, black, blue, red, green, custom colors],
        Sizes, possible values: [XS, S, M, L, XL, XXL],
        Printing Options, possible values: [Screen Printing, Embroidery, Heat Transfer, Direct-to-Garment]""")
    not_mandatory_product_features: str = dedent(
        """Print picture: it may be any picture or text or nothing if user want just t-short without picture."""
    )
    ...
    async def acall(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        inputs = {
            ...
            "mandatory_product_features": self.mandatory_product_features,
            "not_mandatory_product_features": self.not_mandatory_product_features,
        }
